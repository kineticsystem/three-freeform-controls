import { BufferGeometry, ColorModelString, Float32BufferAttribute, MeshBasicMaterial } from "three";
...
export default class PickPlane extends PickPlaneGroup {
  ...
  public setColor = (color: string) => {
    ...
    planeMaterial.color.set(color as ColorModelString);
    boundaryMaterial.color.set(color as ColorModelString);
  };
}
